// This file is part of Indranet.

// Copyright (C) 2019-2023 Stake Technologies Pte.Ltd.
// SPDX-License-Identifier: GPL-3.0-or-later

// Indranet is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.

// Indranet is distributed in the hope that it will be useful,
...
use forest_client_consensus_common::{ParachainBlockImport, ParachainConsensus};
use forest_client_consensus_relay_chain::Verifier as RelayChainVerifier;
...
where
	...
	RuntimeApi::RuntimeApi: sp_transaction_pool::runtime_api::TaggedTransactionQueue<Block>
		...
		+ forest_primitives_core::CollectCollationInfo<Block>,
	sc_client_api::StateBackendFor<TFullBackend<Block>, Block>: sp_api::StateBackend<BlakeTwo256>,
	Executor: sc_executor::NativeExecutionDispatch + 'static,
	BIQ: FnOnce(
		Arc<TFullClient<Block, RuntimeApi, NativeElseWasmExecutor<Executor>>>,
	...
	Executor: sc_executor::NativeExecutionDispatch + 'static,
{
	...
	let aura_verifier = move || {
		let slot_duration = forest_client_consensus_aura::slot_duration(&*client2).unwrap();

		Box::new(forest_client_consensus_aura::build_verifier::<
			sp_consensus_aura::sr25519::AuthorityPair,
			_,
			_,
			_,
		>(forest_client_consensus_aura::BuildVerifierParams {
...
pub async fn start_indranet_node(
	...
	start_node_impl::<indranet::RuntimeApi, indranet::Executor, _, _>(
        parachain_config,
        selendra_config,
        collator_options,
        id,
        ...
        |client,
         ...
         force_authoring| {
            ...
            let slot_duration =
                forest_client_consensus_aura::slot_duration(&*client).unwrap();
