...
//! # Indranet Runtime
//!
//! Indranet is the canary network for its Selendra.
...
impl forest_pallet_xcmp_queue::Config for Runtime {
	...
	type WeightInfo = forest_pallet_xcmp_queue::weights::SubstrateWeight<Runtime>;
}
...
impl_runtime_apis! {
	...
	impl frame_try_runtime::TryRuntime<Block> for Runtime {
		...
		fn execute_block(block: Block, state_root_check: bool, select: frame_try_runtime::TryStateSelect) -> Weight {
			log::info!(
				target: "runtime::indranet", "try-runtime: executing block #{} ({:?}) / root checks: {:?} / sanity-checks: {:?}",
				block.header.number,
				block.header.hash(),
				state_root_check,
				select,
