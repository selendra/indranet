...
//! The Indranet EVM precompiles. This can be compiled with ``#[no_std]`, ready for Wasm.
...
/// The PrecompileSet installed in the Selendra runtime.
#[derive(Debug, Default, Clone, Copy)]
pub struct SelendraNetworkPrecompiles<R>(PhantomData<R>);

impl<R> SelendraNetworkPrecompiles<R> {
	pub fn new() -> Self {
...
impl<R> PrecompileSet for SelendraNetworkPrecompiles<R>
where
