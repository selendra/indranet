...
use sp_runtime::{
	traits::{BlakeTwo256, DispatchInfoOf, PostDispatchInfoOf, Verify},
	transaction_validity::{TransactionPriority, TransactionValidity, TransactionValidityError},
	Permill,
};

pub type Precompiles = SelendraNetworkPrecompiles<Runtime>;
...
parameter_types! {
	...
	pub PrecompilesValue: Precompiles = SelendraNetworkPrecompiles::<_>::new();
